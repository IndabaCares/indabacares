    ...
    >
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        ...
        <View style={{ marginLeft: 12 }}>
          ...
          <Text style={{ fontSize: 28, fontWeight: 'bold', color: '#ffffff', lineHeight: 32 }}>
            {points}
          </Text>
        </View>
      </View>
...
export default function RewardsScreen() {
  ...
  if (isLoading || pointsLoading) {
    return (
      <SafeAreaView style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: PURPLE }} edges={['top']}>
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <View>
              ...
              <View style={{ backgroundColor: '#ffffff', borderTopLeftRadius: 24, borderTopRightRadius: 24, marginTop: -20, paddingTop: 12 }}>
